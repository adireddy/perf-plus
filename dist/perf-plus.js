...
dat.GUI = dat.gui.GUI = (function (css, saveDialogueContents, styleSheet, controllerFactory, Controller, BooleanController, FunctionController, NumberControllerBox, NumberControllerSlider, OptionController, ColorController, requestAnimationFrame, CenteredDiv, dom, common) {
    ...
    GUI.toggleHide = function() {
        ...
        common.each(hideable_guis, function(gui) {
            gui.domElement.style.zIndex = hide ? -2147483645 : 2147483645;
    ...
    GUI.TEXT_CLOSED = 'Close Perf+ UI';
    GUI.TEXT_OPEN = 'Open Perf+ UI';
    ...
    function addSaveMenu(gui) {
        ...
        if (SUPPORTS_LOCAL_STORAGE) {
            ...
            var saveLocally = document.getElementById('perf-dg-save-locally');
            var explain = document.getElementById('perf-dg-local-explain');

            saveLocally.style.display = 'block';

            var localStorageCheckBox = document.getElementById('perf-dg-local-storage');
        ...
        var newConstructorTextArea = document.getElementById('perf-dg-new-constructor');
   ...
   "<div id=\"perf-dg-save\" class=\"perf-dg dialogue\">\n\n  Here's the new load parameter for your <code>GUI</code>'s constructor:\n\n  <textarea id=\"perf-dg-new-constructor\"></textarea>\n\n  <div id=\"perf-dg-save-locally\">\n\n    <input id=\"perf-dg-local-storage\" type=\"checkbox\"/> Automatically save\n    values to <code>localStorage</code> on exit.\n\n    <div id=\"perf-dg-local-explain\">The values saved to <code>localStorage</code> will\n      override those passed to <code>dat.GUI</code>'s constructor. This makes it\n      easier to work incrementally, but <code>localStorage</code> is fragile,\n      and your friends may not see the same values you do.\n      \n    </div>\n    \n  </div>\n\n</div>",
   ".perf-dg {\n  /** Clear list styles */\n  /* Auto-place container */\n  /* Auto-placed GUI's */\n  /* Line items that don't contain folders. */\n  /** Folder names */\n  /** Hides closed items */\n  /** Controller row */\n  /** Name-half (left) */\n  /** Controller-half (right) */\n  /** Controller placement */\n  /** Shorter number boxes when slider is present. */\n  /** Ensure the entire boolean and function row shows a hand */ }\n  .perf-dg ul {\n    list-style: none;\n    margin: 0;\n    padding: 0;\n    width: 100%;\n    clear: both; }\n  .perf-dg.ac {\n    position: fixed;\n    top: 0;\n    left: 0;\n    right: 0;\n    height: 0;\n    z-index: 0; }\n  .perf-dg:not(.ac) .main {\n    /** Exclude mains in ac so that we don't hide close button */\n    overflow: hidden; }\n  .perf-dg.main {\n    -webkit-transition: opacity 0.1s linear;\n    -o-transition: opacity 0.1s linear;\n    -moz-transition: opacity 0.1s linear;\n    transition: opacity 0.1s linear; }\n    .perf-dg.main.taller-than-window {\n      overflow-y: auto; }\n      .perf-dg.main.taller-than-window .close-button {\n        opacity: 1;\n        /* TODO, these are style notes */\n        margin-top: -1px;\n        border-top: 1px solid #2c2c2c; }\n    .perf-dg.main ul.closed .close-button {\n      opacity: 1 !important; }\n    .perf-dg.main:hover .close-button,\n    .perf-dg.main .close-button.drag {\n      opacity: 1; }\n    .perf-dg.main .close-button {\n      /*opacity: 0;*/\n      -webkit-transition: opacity 0.1s linear;\n      -o-transition: opacity 0.1s linear;\n      -moz-transition: opacity 0.1s linear;\n      transition: opacity 0.1s linear;\n      border: 0;\n      position: absolute;\n      line-height: 19px;\n      height: 20px;\n      /* TODO, these are style notes */\n      cursor: pointer;\n      text-align: center; readonly;\n      background-color: #000; }\n      .perf-dg.main .close-button:hover {\n        background-color: #111; }\n  .perf-dg.a {\n    float: right;\n    margin-right: 15px;\n    overflow-x: hidden; }\n    .perf-dg.a.has-save > ul {\n      margin-top: 27px; }\n      .perf-dg.a.has-save > ul.closed {\n        margin-top: 0; }\n    .perf-dg.a .save-row {\n      position: fixed;\n      top: 0;\n      z-index: 1002; }\n  .perf-dg li {\n    -webkit-transition: height 0.1s ease-out;\n    -o-transition: height 0.1s ease-out;\n    -moz-transition: height 0.1s ease-out;\n    transition: height 0.1s ease-out; }\n  .perf-dg li:not(.folder) {\n    cursor: auto;\n    height: 27px;\n    line-height: 27px;\n    overflow: hidden;\n    padding: 0 4px 0 5px; }\n  .perf-dg li.folder {\n    padding: 0;\n    border-left: 4px solid rgba(0, 0, 0, 0); }\n  .perf-dg li.title {\n    cursor: pointer;\n    margin-left: -4px; }\n  .perf-dg .closed li:not(.title),\n  .perf-dg .closed ul li,\n  .perf-dg .closed ul li > * {\n    height: 0;\n    overflow: hidden;\n    border: 0; }\n  .perf-dg .cr {\n    clear: both;\n    padding-left: 3px;\n    height: 27px; }\n  .perf-dg .property-name {\n    cursor: default;\n    float: left;\n    clear: left;\n    width: 40%;\n    overflow: hidden;\n    text-overflow: ellipsis; }\n  .perf-dg .c {\n    float: left;\n    width: 60%; }\n  .perf-dg .c input[type=text] {\n  readonly;  border: 0;\n    margin-top: 4px;\n    padding: 3px;\n    width: 100%;\n    float: right; }\n  .perf-dg .has-slider input[type=text] {\n    readonly; width: 30%;\n    /*display: none;*/\n    margin-left: 0; }\n  .perf-dg .slider {\n    float: left;\n    width: 66%;\n    margin-left: -5px;\n    margin-right: 0;\n    height: 19px;\n    margin-top: 4px; }\n  .perf-dg .slider-fg {\n    height: 100%; }\n  .perf-dg .c input[type=checkbox] {\n    margin-top: 9px; }\n  .perf-dg .c select {\n    margin-top: 5px; }\n  .perf-dg .cr.function,\n  .perf-dg .cr.function .property-name,\n  .perf-dg .cr.function *,\n  .perf-dg .cr.boolean,\n  .perf-dg .cr.boolean * {\n    cursor: pointer; }\n  .perf-dg .selector {\n    display: none;\n    position: absolute;\n    margin-left: -9px;\n    margin-top: 23px;\n    z-index: 10; }\n  .perf-dg .c:hover .selector,\n  .perf-dg .selector.drag {\n    display: block; }\n  .perf-dg li.save-row {\n    padding: 0; }\n    .perf-dg li.save-row .button {\n      display: inline-block;\n      padding: 0px 6px; }\n  .perf-dg.dialogue {\n    background-color: #222;\n    width: 460px;\n    padding: 15px;\n    font-size: 13px;\n    line-height: 15px; }\n\n/* TODO Separate style and structure */\n#perf-dg-new-constructor {\n  padding: 10px;\n  color: #222;\n  font-family: Monaco, monospace;\n  font-size: 10px;\n  border: 0;\n  resize: none;\n  box-shadow: inset 1px 1px 1px #888;\n  word-wrap: break-word;\n  margin: 12px 0;\n  display: block;\n  width: 440px;\n  overflow-y: scroll;\n  height: 100px;\n  position: relative; }\n\n#perf-dg-local-explain {\n  display: none;\n  font-size: 11px;\n  line-height: 17px;\n  border-radius: 3px;\n  background-color: #333;\n  padding: 8px;\n  margin-top: 10px; }\n  #perf-dg-local-explain code {\n    font-size: 10px; }\n\n#dat-gui-save-locally {\n  display: none; }\n\n/** Main type */\n.perf-dg {\n  color: #eee;\n  font: 11px 'Lucida Grande', sans-serif;\n  text-shadow: 0 -1px 0 #111;\n  /** Auto place */\n  /* Controller row, <li> */\n  /** Controllers */ }\n  .perf-dg.main {\n    /** Scrollbar */ }\n    .perf-dg.main::-webkit-scrollbar {\n      width: 5px;\n      background: #1a1a1a; }\n    .perf-dg.main::-webkit-scrollbar-corner {\n      height: 0;\n      display: none; }\n    .perf-dg.main::-webkit-scrollbar-thumb {\n      border-radius: 5px;\n      background: #676767; }\n  .perf-dg li:not(.folder) {\n    background: #1a1a1a;\n    border-bottom: 1px solid #2c2c2c; }\n  .perf-dg li.save-row {\n    line-height: 25px;\n    background: #dad5cb;\n    border: 0; }\n    .perf-dg li.save-row select {\n      margin-left: 5px;\n      width: 108px; }\n    .perf-dg li.save-row .button {\n      margin-left: 5px;\n      margin-top: 1px;\n      border-radius: 2px;\n      font-size: 9px;\n      line-height: 7px;\n      padding: 4px 4px 5px 4px;\n      background: #c5bdad;\n      color: #fff;\n      text-shadow: 0 1px 0 #b0a58f;\n      box-shadow: 0 -1px 0 #b0a58f;\n      cursor: pointer; }\n      .perf-dg li.save-row .button.gears {\n        background: #c5bdad url(data:image/png;base64,) 2px 1px no-repeat;\n        height: 7px;\n        width: 8px; }\n      .perf-dg li.save-row .button:hover {\n        background-color: #bab19e;\n        box-shadow: 0 -1px 0 #b0a58f; }\n  .perf-dg li.folder {\n    border-bottom: 0; }\n  .perf-dg li.title {\n    padding-left: 16px;\n    background: black url(data:image/gif;base64,R0lGODlhBQAFAJEAAP////Pz8////////yH5BAEAAAIALAAAAAAFAAUAAAIIlI+hKgFxoCgAOw==) 6px 10px no-repeat;\n    cursor: pointer;\n    border-bottom: 1px solid rgba(255, 255, 255, 0.2); }\n  .perf-dg .closed li.title {\n    background-image: url(data:image/gif;base64,R0lGODlhBQAFAJEAAP////Pz8////////yH5BAEAAAIALAAAAAAFAAUAAAIIlGIWqMCbWAEAOw==); }\n  .perf-dg .cr.boolean {\n    border-left: 3px solid #806787; }\n  .perf-dg .cr.function {\n    border-left: 3px solid #e61d5f; }\n  .perf-dg .cr.number {\n    border-left: 3px solid #2fa1d6; }\n    .perf-dg .cr.number input[type=text] {\n  readonly;    color: #2fa1d6; }\n  .perf-dg .cr.string {\n    border-left: 3px solid #1ed36f; }\n    .perf-dg .cr.string input[type=text] {\n    readonly;  color: #1ed36f; }\n  .perf-dg .cr.function:hover, .perf-dg .cr.boolean:hover {\n    background: #111; }\n  .perf-dg .c input[type=text] {\n readonly;   background: #303030;\n    outline: none; }\n    .perf-dg .c input[type=text]:hover {\n    readonly;  background: #3c3c3c; }\n    .perf-dg .c input[type=text]:focus {\n  readonly;    background: #494949;\n      color: #fff; }\n  .perf-dg .c .slider {\n    background: #303030;\n    cursor: ew-resize; }\n  .perf-dg .c .slider-fg {\n    background: #2fa1d6; }\n  .perf-dg .c .slider:hover {\n    background: #3c3c3c; }\n    .perf-dg .c .slider:hover .slider-fg {\n      background: #44abda; }\n",
